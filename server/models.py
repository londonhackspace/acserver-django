...
class Tool(models.Model):
    ...
    status = models.PositiveIntegerField(
        default=0, choices=((1, "Operational"), (0, "Out of service")))
...
class Permission(models.Model):
    ...
    tool = models.ForeignKey(
        Tool, on_delete=models.CASCADE, related_name='permissions')
    permission = models.PositiveIntegerField(
        choices=((1, "user"), (2, "maintainer")))
    addedby = models.ForeignKey(
        User, related_name="addedpermission", on_delete=models.CASCADE)
